...
@section('conteudo')
    <form action="{{route('novo_emitente')}}" method="POST">
        ...
        <div class=""><br>
            ...
            <label for="cad_emitentes"></label><input type="text" class="form-control" id="cad_emitentes" name="cad_emitentes" placeholder="" required onkeyup="maiuscula(this)">
        </div>
        ...
        {{csrf_field()}}
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- Botão de Apagar -->
                    <a class="fas fa-trash" href="/emitente/delete/{{$emitente->id_empresa_emitente}}" onclick="return confirm('Deseja realmente excluir?')" method="GET"></a>
                </td>
