...
@section('conteudo')
    <form action="{{route('novo_tp_documento')}}" method="POST">
        ...
        <div class=""><br>
            ...
            <label for="tp_documento"></label><input type="text" class="form-control" id="tp_documento" name="tp_documento" placeholder="" required>
        </div>
    ...
    <table class="table table-striped">
        ...
        <!-- Botões de Ação-->
                <td>
                    ...
                    <!-- Botão de Apagar -->
                    <a class="fas fa-trash" href="/tp_documento/delete/{{$tp_documentos->id_tp_documento}}" method="GET"></a>
