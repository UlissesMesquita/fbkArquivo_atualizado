...
@section('conteudo')
    <form action="{{route('origem_update', $edit->id_origem)}}" method="POST">
        ...
        <div class=""><br>
            <label>Origem:</label>
        <label for="cad_origem"></label><input type="text" class="form-control" id="cad_origem" name="cad_origem" placeholder="" value="{{$edit->cad_origem}}" required onkeyup="maiuscula(this)">
        </div>
