...
@section('conteudo')
    <form action="{{route('emitente_update', $edit->id_empresa_emitente)}}" method="POST">
        ...
        <label for="cad_emitentes"></label><input type="text" class="form-control" id="cad_emitentes" name="cad_emitentes" placeholder="" value="{{$edit->cad_emitentes}}" required onkeyup="maiuscula(this)">
        </div>
