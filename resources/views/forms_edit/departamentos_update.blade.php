...
@section('conteudo')
    <form action="{{route('departamento_update', $dep_edit->id_departamento)}}" method="POST">
        ...
        <label for="cad_departamento"></label><input type="text" class="form-control" id="cad_departamento" name="cad_departamento" placeholder="" value="{{$dep_edit->cad_departamento}}" required onkeyup="maiuscula(this)">
        </div>
